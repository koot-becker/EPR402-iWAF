...
class WebAppFirewallInterface:
    def __init__(self, site_name, host='0.0.0.0', port=5000, debug=False, settings=None, rules=None):
...
if __name__ == '__main__':
    waf_interface = WebAppFirewallInterface(site_name='http://172.17.0.1:8001/')
    waf_interface.run()